  ...
  test: {
    ...
    coverage: {
      ...
      thresholds: {
        ...
        'src/lib/validation.ts': { statements: 90, branches: 80, functions: 100, lines: 90 },
        'src/lib/sanitization.ts': { statements: 90, branches: 80, functions: 100, lines: 90 },
        'src/lib/rate-limit.ts': { statements: 80, branches: 70, functions: 100, lines: 80 },
