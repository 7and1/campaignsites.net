...
import { CaseStudyCard, JsonLd, SectionHeading } from '@/components'
import type { CaseStudy } from '@/lib/types'

export const dynamic = 'force-dynamic'
export const metadata: Metadata = {
  title: 'Campaign Case Studies Gallery | CampaignSites.net',
  description: 'Curated landing page case studies with conversion analysis. Real campaigns with annotated teardowns and performance metrics.',
  ...
  alternates: {
    canonical: 'https://campaignsites.net/gallery',
  },
}
